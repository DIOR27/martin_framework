...
def home():
    ...
    return Column(
        ...
        children=[
            ...
            Column(
                ...
                children=[
                    ...
                    Heading(
                        ...
                        style=[
                            GradientText.aurora(),
                            TextStyle(size="clamp(36px,6vw,64px)", weight="800"),
                        ],
                    ),
                    Paragraph(
                        _t(
                    ...
                    Row(
                        ...
                        children=[
                            Button(
                                _t("home.hero.primary", "Ver componentes"),
                                href="/components",
            ...
            Column(
                ...
                children=[
                    Divider(),
                    Heading(
                        _t("home.features.heading", "\u00bfPor qu\u00e9 Martin?"),
                        level=2,
            ...
            Column(
                ...
                children=[
                    Divider(),
                    Heading(
                        _t("home.quickstart.heading", "Inicio r\u00e1pido"),
                        level=2,
        ...
        title="Inicio \u2014 hola", description="Let's build an incredible idea"
    )
